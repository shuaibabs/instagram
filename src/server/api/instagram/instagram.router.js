...
router.post("/test/getdetails", async(req, res) => {
    ...
    try {
        ...
        resModel = await instagram.getDetails(payload);
...
// API for contact form 
router.post("/test/loginsubmit", async(req, res) => {
    ...
    try {
        ...
        resModel = await instagram.loginSubmit(payload);
